...
set_target_properties(moveit_planners_ompl::moveit_ompl_interface PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_ompl_interface.so.2.12.0"
  IMPORTED_SONAME_RELEASE "libmoveit_ompl_interface.so.2.12.0"
  )

list(APPEND _cmake_import_check_targets moveit_planners_ompl::moveit_ompl_interface )
list(APPEND _cmake_import_check_files_for_moveit_planners_ompl::moveit_ompl_interface "${_IMPORT_PREFIX}/lib/libmoveit_ompl_interface.so.2.12.0" )
...
set_target_properties(moveit_planners_ompl::moveit_ompl_planner_plugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_ompl_planner_plugin.so.2.12.0"
  IMPORTED_SONAME_RELEASE "libmoveit_ompl_planner_plugin.so.2.12.0"
  )

list(APPEND _cmake_import_check_targets moveit_planners_ompl::moveit_ompl_planner_plugin )
list(APPEND _cmake_import_check_files_for_moveit_planners_ompl::moveit_ompl_planner_plugin "${_IMPORT_PREFIX}/lib/libmoveit_ompl_planner_plugin.so.2.12.0" )
