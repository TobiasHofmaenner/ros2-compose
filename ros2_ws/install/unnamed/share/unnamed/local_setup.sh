...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/install/unnamed"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/unnamed/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/unnamed/environment/path.sh"
